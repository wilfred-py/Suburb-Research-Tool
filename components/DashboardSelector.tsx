...
export default function DashboardSelector(props: DashboardSelectorProps) {
    ...
    const getButtonCSS = (viewName: string) => {
        if (viewName === props.selectedView) {
            ...
            return `relative focus:outline-none focus:ring-0 whitespace-nowrap mr-2 md:mr-0 md:ml-2.5 p-2 py-1 mb-2 md:py-2 hover:bg-buttonBlue text-left leading-6 text-black font-normal mobile-s:max-md:border-[1.5px] mobile-s:max-md:border-gray rounded rounded-md hover:cursor-pointer select-none`;
        }
    };
