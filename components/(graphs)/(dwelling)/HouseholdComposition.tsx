    ...
    return (
        <>
            <div className="w-full select-none">
                ...
                <div className="flex flex-col items-center lg:items-start pt-6">
                    <div>
                    ...
                    {selectedYear === "2021" && (
                        <div className="w-full mobile-s:max-sm:h-[240px] sm:max-md:h-[400px] md:max-lg:h-[240px] lg:h-[400px] select-none">
                            <ResponsiveContainer>
