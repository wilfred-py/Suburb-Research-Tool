    ...
    return (
        <>
            <div className="flex flex-col place-items-center">
                <div className="flex flex-col mobile-s:max-mobile-l:w-[260px] h-[440px] w-[384px] mobile-s:max-mobile-l:mb-10 mb-2">
                    ...
                    <ResponsiveContainer>
                        ...
                        >
                            ...
                            />
                            <Tooltip offset={20} allowEscapeViewBox={{ x: false, y: true }} />
