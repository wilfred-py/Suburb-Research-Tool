...
export default function BedroomsStackedAreaChart(props: BedroomsStackedAreaChartProps) {
    ...
    return (
        <div className="flex flex-col place-items-center">
            <div className="flex flex-col mobile-s:max-mobile-l:w-[260px] mobile-s:max-mobile-l:h-[440px] mobile-l:max-md:w-[360px] sm:max-md:h-[420px] md:max-md-l:w-[300px] md-l:h-[440px] md-l:w-[360px] mobile-s:max-mobile-l:mb-6 mb-2">
                ...
                <ResponsiveContainer>
                    ...
                    >
                        ...
                        <Area type="monotone" dataKey="2 BR" stackId="1" stroke="#FCE09B" fill="#FCE09B" />
            ...
            <div className="flex flex-col mobile-s:max-mobile-l:w-[260px] mobile-s:max-mobile-l:h-[440px] mobile-l:max-md:w-[360px] sm:max-md:h-[420px] md:max-md-l:w-[300px] md-l:h-[440px] md-l:w-[360px] mobile-s:max-mobile-l:mt-4 mt-2 mobile-s:max-mobile-l:mb-20 mobile-l:mb-6">
