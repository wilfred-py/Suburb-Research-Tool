...
export default function BedroomsStackedAreaChart(props: BedroomsStackedAreaChartProps) {
    ...
    return (
        <div className="flex flex-col place-items-center">
            ...
            <div className="flex flex-col mobile-s:max-mobile-l:w-[260px] mobile-s:h-[440px] mobile-l:w-[384px] mobile-s:max-mobile-l:mt-4 mt-2 mobile-s:max-mobile-l:mb-10 ">
