...
export default function ExampleUnemploymentLineGraph(props: UnemploymentProps) {
    ...
    const [suburbUnemployment, setSuburbUnemployment] = useState<(number | null)[]>([6.4, 4.6, 4.6, 5.3, 4]);
    const [stateUnemployment, setStateUnemployment] = useState<(number | null)[]>([null, null, 5.4, 6.6, 5]);
        ...
        <div className="w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80">
            <ResponsiveContainer>
                <LineChart data={data} margin={{ top: 30, right: 40, bottom: 30, left: 0 }}>
                    ...
                    <YAxis tickCount={6} domain={[0, dataMax + 2]}>
        ...
        <div>
            <div className="flex flex-col justify-center select-none">
                <h1 className="mx-auto mt-4 text-base text-center">
                    Unemployment in <p className="text-base italic font-medium">Abbotsford, VIC, 3067</p>
                </h1>
