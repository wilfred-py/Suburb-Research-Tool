...
export default function PartTimeEmploymentLineGraph(props: PartTimeEmploymentProps) {
    ...
    const [suburbPartTime, setSuburbPartTime] = useState<(number | null)[]>([null, null, null, null, null]);
    const [statePartTime, setStatePartTime] = useState<(number | null)[]>([null, null, null, null, null]);
