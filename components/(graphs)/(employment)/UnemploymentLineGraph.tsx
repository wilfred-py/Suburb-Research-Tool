            ...
            validData.forEach((result) => {
                ...
                try {
                    ...
                    // * 2021
                        ...
                        const percentageSuburbUnemployment = data[0]["employment_data"]["Employment status"]["Unemployed"]["% of suburb"];
                        const percentageStateUnemployment = data[0]["employment_data"]["Employment status"]["Unemployed"]["% of state"];
