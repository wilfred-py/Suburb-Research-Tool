...
//     useEffect(() => {
//         async function fetchData() {
//             console.log(`selected suburb: ${props.selectedSuburb}`);
...
//                         // * 2001
//                         if (year == "2001") {
//                             console.log(`${year} data: ${data[0]["employment_data"]["Employment People aged 15 years and over"]}`);
//                             const percentageSuburbFullTime =
//                                 data[0]["employment_data"]["Employment People aged 15 years and over"]["Worked full-time"]["% of suburb"];
...
//                             const percentageAustraliaFullTime =
//                                 data[0]["employment_data"]["Employment People aged 15 years and over"]["Worked full-time"][
//                                     "% of Australia"
//                                 ];
...
//                         // * 2006
//                         else if (year == "2006") {
//                             console.log(`${year} data: ${data[0]["employment_data"]}`);
//                             const percentageSuburbFullTime =
//                                 data[0]["employment_data"]["Employment People aged 15 years and over"]["Worked full-time"]["% of suburb"];
//                             const percentageStateFullTime =
//                                 data[0]["employment_data"]["Employment People aged 15 years and over"]["Worked full-time"]["% of state"];
...
//                         else if (year == "2011") {
//                             const percentageSuburbFullTime =
//                                 data[0]["employment_data"][
//                                     "Employment People who reported being in the labour force, aged 15 years and over"
//                                 ]["Worked full-time"]["% of suburb"];
//                             const percentageStateFullTime =
//                                 data[0]["employment_data"][
//                                     "Employment People who reported being in the labour force, aged 15 years and over"
//                                 ]["Worked full-time"]["% of state"];
//                             const percentageAustraliaFullTime =
//                                 data[0]["employment_data"][
//                                     "Employment People who reported being in the labour force, aged 15 years and over"
//                                 ]["Worked full-time"]["% of Australia"];
...
//                             }
//                         }
//                         // Resolve the promise here to indicate successful data fetch
//                         resolve();
//                     });
//                 } catch (error) {
//                     // reject(error);
