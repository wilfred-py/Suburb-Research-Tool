...
export default function ExampleHouseholdMedianWeeklyIncome(props: HouseholdIncomeProps) {
    const [selectedSuburb, setSelectedSuburb] = useState<string | null>("");
    const [selectedState, setSelectedState] = useState<string | null>("");

    const [suburbHouseholdIncome, setSuburbHouseholdIncome] = useState<(number | null)[]>([null, 1301, 1793, 2001, 2197]);
    const [stateHouseholdIncome, setStateHouseholdIncome] = useState<(number | null)[]>([null, null, 1216, 1419, 1759]);
    ...
    return (
        <div>
            <div className="flex flex-col justify-center">
                <h1 className="mt-4 mb-4 mx-2 text-base text-center font-bold">Household Median Weekly Income</h1>
