...
// Bachelor Width
const bachelorWidth =
    Math.round(Math.floor(((bachelorInSuburb / 100) * 208) / 4) / 4) * 4;
...
// Diploma Width
const diplomaWidth =
    Math.round(Math.floor(((diplomaInSuburb / 100) * 208) / 4) / 4) * 4;

// Certificate
const certificateOneInSuburb = parseFloat(
    mainData["Level of highest educational attainment"]["Certificate level I"][
        "% of suburb"
    ]
);
const certificateTwoInSuburb = parseFloat(
    mainData["Level of highest educational attainment"]["Certificate level II"][
        "% of suburb"
    ]
);
...
const certificateFourInSuburb = parseFloat(
    mainData["Level of highest educational attainment"]["Certificate level IV"][
        "% of suburb"
    ]
);
...
// Certificate Width
const certificatesWidth =
    Math.round(Math.floor(((certificatesInSuburb / 100) * 208) / 4) / 4) * 4;

// High School
const yearTwelveInSuburb = parseFloat(
...
// High School Width
const highSchoolWidth =
    Math.round(Math.floor(((yearTwelveInSuburb / 100) * 208) / 4) / 4) * 4;

// No Education
const noEducationInSuburb = parseFloat(
    mainData["Level of highest educational attainment"][
...
// No Education Width
const noEducationWidth =
    Math.round(Math.floor(((noEducationInSuburb / 100) * 208) / 4) / 4) * 4;

// Not stated
const notStatedInSuburb = parseFloat(
...
// Not Stated Width
const notStatedWidth =
    Math.round(Math.floor(((notStatedInSuburb / 100) * 208) / 4) / 4) * 4;
    ...
    return (
        <div className="rounded border border-black w-112 m-4">
            ...
            <div className="bg-gray-200 w-52 rounded relative h-6 mb-2">
                <div
                    className={`bg-customYellow rounded w-${
                        bachelorWidth == 0 ? 1.5 : bachelorWidth
            ...
            <div className="bg-gray-200 w-52 rounded relative h-6 mb-2">
                <div
                    className={`bg-customYellow rounded w-${
                        diplomaWidth == 0 ? 1.5 : diplomaWidth
                    } absolute top-0 left-0 h-6`}
                >
            ...
            <div className="bg-gray-200 w-52 rounded relative h-6 mb-2">
                <div
                    className={`bg-customYellow rounded w-${
                        certificatesWidth == 0 ? 1.5 : certificatesWidth
                    } absolute top-0 left-0 h-6`}
                >
            ...
            <div className="bg-gray-200 w-52 rounded relative h-6 mb-2">
                <div
                    className={`bg-customYellow rounded w-${
                        highSchoolWidth == 0 ? 1.5 : highSchoolWidth
                    } absolute top-0 left-0 h-6`}
                >
            ...
            <div className="bg-gray-200 w-52 rounded relative h-6 mb-2">
                <div
                    className={`bg-customYellow rounded w-${
                        noEducationWidth == 0 ? 1.5 : noEducationWidth
                    } absolute top-0 left-0 h-6`}
                >
            ...
            <div className="bg-gray-200 w-52 rounded relative h-6 mb-2">
                <div
                    className={`bg-customYellow rounded w-${
                        notStatedWidth == 0 ? 1.5 : notStatedWidth
                    } absolute top-0 left-0 h-6`}
                >
