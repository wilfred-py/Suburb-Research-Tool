...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
    return (
        <section className="min-h-screen flex-1 flex flex-row overflow-hidden">
            <div id="left-panel" className="flex flex-col relative xl:w-1/3 w-full ">
            ...
            <div
                id="right-panel"
                className="flex flex-col flex-1 relative xl:flex sm:max-xl:hidden max-sm:hidden justify-center items-center"
            >
